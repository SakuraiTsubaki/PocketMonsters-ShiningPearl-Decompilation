# Milestones: Pocket Monsters Shining Pearl

This roadmap governs research, tooling, analysis, reconstruction, and preservation for `SakuraiTsubaki/PocketMonsters-ShiningPearl-Decompilation`.
...
| Field | Current value |
| --- | --- |
| Target | Pocket Monsters Shining Pearl |
...
Coordinate with Brilliant Diamond while documenting engine, managed-code, native-module, and asset boundaries from evidence.
